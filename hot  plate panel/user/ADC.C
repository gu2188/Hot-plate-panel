...
u32 thermistor_voltage_data_power;
...
void adc_res_voltage_data(void)
{
    double a=0;
    res_voltage_data=0;
    res_voltage_data=ADC_RES*4+ADC_RESL;
...
void adc_thermistor_voltage_data(void)
{
    ...
    thermistor_voltage_data=ADC_RES*4+ADC_RESL;
    a=thermistor_voltage_data*(5.0000/1024.000);
    thermistor_voltage_data_power=((996.0000*a)/(5.0000-a));
}
